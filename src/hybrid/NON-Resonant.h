...
void Gamma_WNN( int nucleon, int process, int decay, int cross, double Qsq, double Q[], Matrix WNN[] ){
...
void S_Nprop( double W2, double kResonance[], Matrix &Nprop ){
  ...
  Prop_FF = 1. /( W2 - MN2 )*( kResonance[0]*Gamma[0] - kResonance[1]*Gamma[1] - kResonance[2]*Gamma[2] - kResonance[3]*Gamma[3] + MN*Id );
...
void NP_current( int process, int nucleon, int decay, int Helicity, int cross, double Qsq, double W2, double Q[], double kResonance[], Matrix kpiSlash, Matrix Op_NP[] )
{
...
// cout << cross << " " << decay << " " << nucleon << " " << icNP << endl;
...
//       // -W N N- vertex      
      Matrix WNN[4];
      Gamma_WNN( nucleon, process, decay, cross, Qsq, Q, WNN ); 
//       // NUCLEON PROPAGATOR (NP)
      Matrix Nprop;
      S_Nprop( W2, kResonance, Nprop );
//       // -N pi N- vertex 
      Matrix NNpi;
...
void CNP_current( int process, int nucleon, int decay, int Helicity, int cross, double Qsq, double W_cross2, double Q[], double kRes_cross[], Matrix kpiSlash, Matrix Op_NP_cross[] )
{      
...
//       // -W N N- vertex      
      Matrix WNN_cross[4];
      Gamma_WNN( nucleon, process, decay, cross, Qsq, Q, WNN_cross ); 
//       // NUCLEON PROPAGATOR (NP)
      Matrix Nprop_cross;
      S_Nprop( W_cross2, kRes_cross, Nprop_cross );
//       // -N pi N- vertex 
      Matrix NNpi_cross;  
      double fact = icNP * (-gA)/(fpi*sqrt(2.));
