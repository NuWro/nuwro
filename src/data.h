...
const double SBy[10] = {0.020, 0.160, 0.263, 0.153, 0.129, 0.098, 0.065, 0.034, 0.022, 0.050};
const double SByerr[10] = {0.003, 0.013, 0.018, 0.011, 0.012, 0.010, 0.010, 0.008, 0.008, 0.030};
