...
{
  double tau = Q2/4.0/mecM2;
  return 4.0*tau*mecGa(Q2,opcja)*( mecF1(Q2,opcja) + mecF2(Q2,opcja) );// minus for antineutrinos
}
...
static double mecccqe_cross (double E, double Q2, int opcja, bool PB)//SIGN
{
...
//////////////////////////////////////////////
static double mec_cross (double E, double Q2)
{
  return mecccqe_cross (E, Q2, 3, true) - mecccqe_cross (E, Q2, 2, true);
}
///////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////
void model_2body3 (double E, double w, double q, double Bin, particle &meclep, particle &nuc1, particle &nuc2)
{      
  ...
  while ( ( sumadd.t < sumadd.length() )   ||   ( sumadd*sumadd <4.0*mecM2 ) );//to be able to make Lorentz boost and to "decay"
    //cout<<"po"<<endl;
  trans= sumadd.v();
...
double mecweight3 (double E, bool cc, int mecA, particle &meclepton, particle &mecnucleon1, particle &mecnucleon2)
{
double W2 = 2.0*mecM*E + mecM2;
...
double weight;
  ...
  model_2body3 (E, w, q, 8, meclepton, mecnucleon1, mecnucleon2);
  //cout<<mecnucleon1.pdg<<"  "<<mecnucleon1.t<<endl;
  //cout<<"sleep"<<endl;
  weight = (Q2max(E)-Q2min(E))*mec_cross (E, Q2)/2.0/1e38;
