...
static double Pauli (double Q2)
{
	if ( (Q2<0.2*1e6) && (Q2>0) )
		...
		return 1.0;
								 ...
								 //SIGN
static double mecccqe_cross (double E, double Q2, int opcja, bool PB)
{
...
double mecweight3 (double E, bool nu, bool cc, int mecA, particle &meclepton, particle &mecnucleon1, particle &mecnucleon2)
{
