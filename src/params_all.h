...
PARAM(bool,NeuralNetwork_guided,1)\
PARAM(bool,HardwareSupport,0)\
PARAM(int,NumberOfCores,4)\
PARAM(int,NumberOfNetworks,50)\
PARAM(string,NeuralNetwork_model_dir,"")\
PARAM(int,eWro_mec_kind,1)\
PARAM(double,eWro_mec_ratio_pn,0.90)\
PARAM(double,eWro_mec_ratio_pp,0.05)\
PARAM(double,eWro_mec_ratio_nn,0.05)\
PARAM(int,eWro_spp_kind,3)\
PARAM(bool,FSI_on,1)\
