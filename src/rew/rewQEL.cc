...
static double E_bind(params& p, nucleus & t, particle &N0)
{
  ...
  */
  ...
  {
    case 0:  return 0;                      
    case 1:  return p.nucleus_E_b;          
    case 2:  return t.Ef(N0) + p.kaskada_w;
    case 3:  return 0;                      
    case 4:  return binen (N0.p(), p.nucleus_p, p.nucleus_n); 
    case 5:  return deuter_binen (N0.p());  //deuterium 
    case 6:  return p.nucleus_E_b;          //deuterium like Fermi gas
    default: return 0;
  }
}
...
{ 
  ...
  */
  ...
  int kind=e.flag.nc*(N0.proton()?1:2);/// process type: 0 - cc, 1 - nc proton, 2 - nc neutron
