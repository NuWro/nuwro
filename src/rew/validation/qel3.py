...
with PdfPages("qel_delta_s.pdf") as pdf:
    for what in whats:
        plt.figure()
        ...
        plt.plot(x1, y1, 'r-', label='$\Delta s = 0.2$')
        plt.plot(x2, y2, 'b-', label='$\Delta s = -0.2$')
        plt.plot(x1r, y1r, 'r*', label='$\Delta s = 0$ rew to $0.2$')
        plt.plot(x2r, y2r, 'b*', label='$\Delta s = 0$ rew to $-0.2$')
