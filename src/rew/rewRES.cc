...
double GetEBind(event &nuwro_event, params const &rwparams) {
  switch (rwparams.nucleus_target) {
    case 0:
      return 0;  // free
    case 1:
      return rwparams.nucleus_E_b;  // FG
    case 2:
      return 0;  // local FG
    case 3:
      return 0;  // Bodek
    case 4:
      return binen(nuwro_event.in[1].p(), rwparams.nucleus_p, rwparams.nucleus_n);  // effective SF
    case 5:
      return deuter_binen(nuwro_event.in[1].p());  // deuterium
    case 6:
      return rwparams.nucleus_E_b;  // deuterium like Fermi gas
    default:
      return 0;
  }
}
