...
int
form_faktory_wektorowe (int Form_Faktory, double Q2, double W, int NC_czy_CC,
			double *c3v, double *c4v, double *c5v, double *c6v)
{
  ...
  switch (Form_Faktory)
    ...
    case I:
      funkcja = 1.95 / pow (1 + Q2 / MW / MW, 2) / (1 + Q2 / 4 / MW / MW);
      break;
...
int
form_faktory_aksjalne (int Form_Faktory, double Q2, double W, double *c3a,
...
//currently as default only the set II is active
  switch (Form_Faktory)
    {
    case I:
      MA = 1.05 * GeV;
    ...
    case Ib:
      MA = 0.95 * GeV;
      funkcja5 =
	1.2 / pow (1 + Q2 / MA / MA, 2) / pow (1 + Q2 / MA / MA / 3, 2);
      funkcja3 = 0;
      funkcja4 = -0.25 * funkcja5;
      funkcja6 = funkcja5 * MM / (Q2 + m_pi * m_pi);
      break;
...
int
tensor_hadronowy (int Form_Faktory, double E, double Q2, double W, double *W1,
...
double
dif_cross_q0_W (int Form_Faktory, double E, double q0, double W)
{
...
int
Przekroje_Czynne_q0_W_NC (int Form_Faktory, double Energia, double q0,
...
int
Przekroje_Czynne_q0_W_CC (int Form_Faktory, double Energia, double q0,
			  double W, double m_l, int FF, double *CC_n_p_plus,
...
//functtion by JN
//it takes as the default the set II of FF as stated in the argument of dif_cross_q0_W(II, E, nu,  W);
double
cr_sec_delta (double E, double W, double nu, int lepton_in, int nukleon_in,
	      int nukleon_out, int meson_out, bool current)
{
