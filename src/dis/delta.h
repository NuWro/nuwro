...
int form_faktory_wektorowe (int Form_Faktory, double Q2, double W,
			    int NC_czy_CC, double *c3v, double *c4v,
			    double *c5v, double *c6v);

int form_faktory_aksjalne (int Form_Faktory, double delta_axial_mass, double delta_C5A, double Q2, double W, double *c3a,
...
double dif_cross_q0_W (int Form_Faktory, double delta_axial_mass, double delta_C5A, double E, double q0, double W);
...
int Przekroje_Czynne_q0_W_NC (int Form_Faktory, double delta_axial_mass, double delta_C5A, double Energia, double q0,
			      double W, int FF, double *NC_n_p_p0,
			      double *NC_n_n_pi_plus, double *NC_n_n_p0,
			      double *NC_n_p_pi_minus, double *NC_an_p_p0,
			      double *NC_an_n_pi_plus, double *NC_an_n_p0,
			      double *NC_an_p_pi_minus);
...
int Przekroje_Czynne_q0_W_CC (int Form_Faktory, double delta_axial_mass, double delta_C5A, double Energia, double q0,
			      double W, double m_l, int FF,
			      double *CC_n_p_plus, double *CC_n_n_p_plus,
			      double *CC_n_p_p0, double *CC_an_p_plus,
			      double *CC_an_n_p_plus, double *CC_an_p_p0);

//functtion by JN
double cr_sec_delta (int FFset, double delta_axial_mass, double delta_C5A, double E, double W, double nu, int lepton_in,
