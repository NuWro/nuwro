...
double FINAL_RESULTS [22] [katbins] [kinbins];//0 data 1 errors 2 mec; 3-21 varying axial mass

void crosssections (double cross[], ifstream& Input)//read cross section from the file .root.txt
{
string y;
double x;
if (Input)
