...
protected:
   ...
   double mass;
public:
 beam_singleroothist(NUWRO::params& p):g(p.beam_inputroot,p.beam_inputroot_flux),dir(p.beam_direction.dir()),pdg(p.beam_particle), mass(PDG::mass(p.beam_particle))
   {
   }
